...
export default function Home() {
  // useEffect(() => {
  //     const imageData = "hihiha"; // Data gambar yang akan dikirimkan ke API

  //     axios.post('/api/predict', { image_data: imageData })
  //         .then(response => {
...
//     if (selectedImage) {
//       // Convert selectedImage to base64 or FormData, depending on API requirements
//       const imageData = await convertImageToBase64(selectedImage);

//       // Send imageData to API
//       try {
//         const response = await fetch('http://127.0.0.1/api/predict', {
//           method: 'POST',
//           headers: {
...
//   useEffect(() => {
//     const interval = setInterval(captureImage, 10000); // Capture every 10 seconds
